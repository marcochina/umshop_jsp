...
var confirm=function(){
    ...
    this.init=function(options,callback){
        ...
        var boardCSS='position:fixed;width:218px;height:170px;background:#ffffff;z-index:255;left:50%;top:50%;margin-left:-142px;margin-top:-85px;text-align:center;padding:0 33px';
